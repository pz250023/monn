...
4. 设置环境变量 NEXT_PUBLIC_STORAGE_TYPE，值为 **upstash**
5. 重试部署
...
4. 设置环境变量 NEXT_PUBLIC_STORAGE_TYPE，值为 **d1**
5. 重试部署
...
| 变量                              | 说明                                         | 可选值                           | 默认值                                                                                                                     |
| --------------------------------- | -------------------------------------------- | -------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| ~~USERNAME~~                      | ~~已移除：不再需要管理员账号~~               | ~~任意字符串~~                   | ~~（空）~~                                                                                                                 |
| ~~PASSWORD~~                      | ~~已移除：不再需要密码认证~~                 | ~~任意字符串~~                   | ~~（空）~~                                                                                                                 |
...
**注意：应用已移除用户认证和管理员功能，所有用户都可以直接使用全部功能。**
...
应用已移除密码认证，支持以下数据存储模式：

- **本地存储模式**：数据保存在浏览器本地，无需任何配置
- **数据库模式**：数据保存在 Redis、D1 或 Upstash 数据库中，支持多设备同步

### 使用建议

1. **个人使用**：建议仅供个人或家庭使用
2. **数据备份**：重要的收藏和播放记录建议定期备份
3. **遵守法律**：请确保您的使用行为符合当地法律法规
